...
time CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} CANDLE_DATA_DIR=${CANDLE_DATA_DIR} TRAIN_DATA_SOURCE=${TRAIN_DATA_SOURCE} SPLIT=${SPLIT} TEST_DATA_SOURCE=${TEST_DATA_SOURCE} $DPP_CMD
echo "running command ${CMD}"
time CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} CANDLE_DATA_DIR=${CANDLE_DATA_DIR} TRAIN_DATA_SOURCE=${TRAIN_DATA_SOURCE} SPLIT=${SPLIT} TEST_DATA_SOURCE=${TEST_DATA_SOURCE} $CMD

time CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} CANDLE_DATA_DIR=${CANDLE_DATA_DIR} TRAIN_DATA_SOURCE=${TRAIN_DATA_SOURCE} SPLIT=${SPLIT} TEST_DATA_SOURCE=${TEST_DATA_SOURCE} $TEST_CMD
